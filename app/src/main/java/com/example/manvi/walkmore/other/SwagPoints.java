package com.example.manvi.walkmore.other;
...
public class SwagPoints extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressPaint.setColor(ContextCompat.getColor(getContext(), R.color.progressColor));
...
//
//        SweepGradient gradient = new SweepGradient(250, 200,
...
//		Log.d("onDraw", String.valueOf(mPoints));
        canvas.drawText(getContext().getString(R.string.totalSteps, mPoints), xPos, yPos, mTextPaint);
...
//				System.out.printf("-- %d, %d, %f\n", progress, mPoints, mProgressSweep);
    ...
    public void animateRevealShow(final View viewRoot, final ImageView imageFlag, final TextView mRemaining) {

        final Animation anim = AnimationUtils.loadAnimation(getContext(), R.anim.rotation);
        viewRoot.setVisibility(View.INVISIBLE);
        mRemaining.setVisibility(INVISIBLE);
        imageFlag.setVisibility(VISIBLE);
        imageFlag.setAnimation(anim);
        ...
        anim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                imageFlag.setVisibility(INVISIBLE);
                viewRoot.setVisibility(View.VISIBLE);
                mRemaining.setVisibility(VISIBLE);
            }
